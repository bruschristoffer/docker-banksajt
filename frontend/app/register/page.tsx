    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setMessage(data.message || 'Kunde inte skapa användaren');
            }
        } catch (error) {
            setMessage('Något gick fel vid skapandet av användaren.');
        }
    };
    ...
    return (
        <div className="min-h-screen bg-zinc-50 text-zinc-900 p-8">
            ...
            <main className="max-w-md mx-auto">
                <h1 className="text-2xl font-bold mb-4">Skapa användare</h1>
